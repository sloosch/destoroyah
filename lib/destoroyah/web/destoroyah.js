...
that = function(guard) {
  var _finally, collected, maybeNot;
  if (guard == null) {
    guard = function() {
      return true;
    };
  ...
  maybeNot = function() {
    var args, f, inv;
    inv = arguments[0], f = arguments[1], args = 3 <= arguments.length ? slice.call(arguments, 2) : [];
    if (!inv) {
...
exports.Rampage = Rampage = (function(superClass) {
  extend(Rampage, superClass);
